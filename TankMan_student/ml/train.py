...
from stable_baselines3.common.vec_env import SubprocVecEnv #啟用多核引用的packet
...
def parser_arg() -> Namespace:
    ...
    parser.add_argument("--n-envs", type=int, default=16) #運用CPU的16個threads
...
def train(opts: Namespace) -> None:
    ...
    vec_env = make_vec_env(
        ...
        n_envs=opts.n_envs,
        vec_env_cls=SubprocVecEnv #開啟多核模式
    )
